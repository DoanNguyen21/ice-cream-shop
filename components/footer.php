<div class="newsletter">
    <div class="content">
        <span>get latest ice cream-Gin updates</span>
        <h1>subscribe our newsletter</h1>
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsam explicabo sit est eos <br>
            earum reprehenderit inventore nam autem corrupti retum!</p>
...
<footer>
    <div class="content">
        ...
        <div class="box">
            <h3>contact us</h3>
            <p><i class="bx bxs-phone"></i>(037) 911-****</p>
            <p><i class="bx bxs-envelope"></i>gindisme21@gmail.com</p>
            <p><i class="bx bxs-location-plus"></i>Viet Nam</p>
            <div class="icons">
    ...
    <div class="bottom">
        <p>Copyright © 2024 code with doan nguyen. All Rights Reserved</p>
