<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        //update name
        if(!empty($name)){
            $update_name = $conn->prepare("UPDATE `tbl_users` SET name = ? WHERE id = ?");
        ...
        //update email
        if (!empty($email)) {
            $select_email = $conn->prepare("SELECT * FROM `tbl_users` WHERE id = ? AND email =?");
...
<head>
    ...
    <title>IceCream-GinD - update profile login page</title>
