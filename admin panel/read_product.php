<?php
   ...
   if(isset($_POST['delete'])){
    ...
    $delete_image = $conn->prepare("SELECT * FROM `tbl_products` WHERE id= ? AND seller_id =? ");
    ...
    $delete_product = $conn->prepare("DELETE FROM `tbl_products` WHERE id = ? AND seller_id = ?");
...
<head>
    ...
    <title>IceCream-GinD - Show Products page</title>
        ...
        <section class="read-post">
            ...
            <div class="box-container">
                ...
                <?php 
                        ...
                        echo '
                        <div class="empty">
                        <p>no products added yet! <br> <a href="add_products.php" class="btn" style="margin-top: 1.5rem;">add
                                products</a></p>
                        </div>
                        ';
                    }
