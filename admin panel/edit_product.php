<?php
    ...
    if (isset($_POST['update'])) {
        ...
        $update_product = $conn->prepare("UPDATE `tbl_products`SET
        name =?, price = ?, product_detail =?, stock = ?,status =? WHERE id = ?");
        ...
        if(!empty($image)){
            if($image_size > 2000000){
               ...
               $warning_msg[] = 'please rename your image';
                ...
                $update_image = $conn->prepare("UPDATE `tbl_products` SET 
                image = ? WHERE id =?");
    ...
    if (isset($_POST['delete_image'])) {
        ...
        $delete_image = $conn->prepare("SELECT * FROM `tbl_products` WHERE id = ?");
        ...
        $unset_image = $conn->prepare("UPDATE `tbl_products` SET image =? WHERE id =?");
    ...
    if(isset($_POST['delete_product'])){
        ...
        $delete_product = $conn->prepare("DELETE FROM `tbl_products` WHERE id =?");
    ...
    <div class="main-container">
        ...
        <section class="post-editor">
            ...
            <div class="box-container">
                <?php
                    $product_id = $_GET['id'];
                    $select_product = $conn->prepare("SELECT * FROM `tbl_products` WHERE id = ? AND 
                       seller_id = ?");
                        ...
                        <div class="input-field">
                            ...
                            <div class="flex-btn">
                                ...
                                <a href="view_product.php" class="btn"
                                    style="width:49%; text-align: center; height: 3rem ; margin-top: 0.7rem;">
                                    go back</a>
                            </div>
                            <?php } ?>
                        </div>
